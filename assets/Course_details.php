...
class Course_details extends CI_Controller{
    ...
    function index()
    {
        ...
        $config['base_url'] = site_url('course_details/index?');
        $config['total_rows'] = $this->Course_details_model->get_all_course_details_count();
        $this->pagination->initialize($config);

        $data['course_details'] = $this->Course_details_model->get_all_course_details($params);
...
$this->form_validation->set_rules('curriculam','Curriculam','trim|required');
