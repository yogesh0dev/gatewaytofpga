...
$config['pagination']['next_tag_open'] = '<li class="page-numbers">';
$config['pagination']['next_tag_close'] = '</li>';
$config['pagination']['prev_tag_open'] = '<li class="page-numbers">';
$config['pagination']['prev_tag_close'] = '</li>';
$config['pagination']['num_tag_open'] = '<li class="page-numbers">';
...
$config['pagination']['first_tag_open'] = '<li class="page-numbers">';
$config['pagination']['first_tag_close'] = '</li>';
$config['pagination']['last_link'] = '››';
$config['pagination']['last_tag_open'] = '<li class="page-numbers">';
