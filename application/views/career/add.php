	...
	<div>
		...
		<input class="form-control"placeholder='Course' type="text" name='course' value="<?php echo $this->input->post('course'); ?>" />
		<span class="text-danger"><?php echo form_error('course');?></span>
	</div>
	<div>
		<span class="text-danger">*</span><label class="form-label">Message : </label>
		<input class="form-control"placeholder='Message' type="text" name='message' value="<?php echo $this->input->post('message'); ?>" />
