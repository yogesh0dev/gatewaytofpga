   ...
   <div class="row">
      ...
      <tr>
		<td>
         ...
         <td>
			<a href="<?=site_url().'marks/'.$cst['id'];?>"><span class="badge info-inter">Add Test Marks</span></a><br><br>
			<a href="<?=site_url().'assignments/'.$cst['id'];?>"><span class="badge info-inter">Add Assignments Marks</span></a>
		</td>
      </tr>
		<?php }?>
