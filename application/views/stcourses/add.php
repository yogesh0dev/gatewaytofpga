	<?php 
		...
		echo form_open_multipart("stcourses/add",$attributes); 
		// imgs icons 
	?>
<?php if(@$error['error']){?>
...
<?php }?>
	<div>
		...
		<input class="form-control"placeholder='stcourses' type="text" name='stcourses' value="<?php echo $this->input->post('stcourses'); ?>" />
