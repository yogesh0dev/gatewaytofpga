              ...
              <div class="dropdown-menu dropdown-menu-end p-0">
               ...
               <div class="header-message-list p-2">
                  <div class="dropdown-item bg-light radius-10 mb-1">
                   ...
                   <a class="dropdown-item" href="#">
                     <div class="d-flex align-items-center">
                        <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="52" height="52">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="52" height="52">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="52" height="52">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="52" height="52">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="52" height="52">
                       <div class="ms-3 flex-grow-1">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                       <img src="<?=site_url();?>/assets/admin/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="52" height="52">
                       <div class="ms-3 flex-grow-1">
