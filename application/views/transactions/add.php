	<?php 
		...
		echo form_open_multipart("transactions/add",$attributes); 
		// imgs icons 
	?>
<?php if(@$error['error']){?>
...
<?php }?>
	<div>
		...
		<input class="form-control"placeholder='transactions' type="text" name='transactions' value="<?php echo $this->input->post('transactions'); ?>" />
